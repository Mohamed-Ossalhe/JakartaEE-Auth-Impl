...
<body id="page-top">
	<input type="hidden" id="status" name="status" value="<%= request.getAttribute("status") != null ? request.getAttribute("status") : "" %>">
	<!-- Navigation-->
	<nav
		class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top"
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Mohamed OS</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="${pageContext.request.contextPath}/logout">Logout</a></li>
					<li class="nav-item mx-0 mx-lg-1 bg-danger"><p
							class="nav-link py-3 px-0 px-lg-3 rounded"><%=session.getAttribute("username")%></p></li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To JakartaEE simple auth</h1>
			<!-- Icon Divider-->
			...
			<p class="masthead-subheading font-weight-light mb-0">Java
				Development - JakartaEE Development - JDBC</p>
		</div>
	</header>
	<!-- Portfolio Section-->
